...
urlpatterns = [
    ...
    path('dashboard/admin/reject/<int:app_id>/', views.admin_reject_application, name='admin_reject_application'),
    path('idcard/<int:app_id>/', views.id_card_view, name='id_card_view'),
